...
<body>
  ...
  <section style=" width:92%; margin-top:50px; margin-left:4%; margin-right:4%; margin-bottom:20px" id="chefs" class="chefs">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          if(mysqli_num_rows($recordchef)>0){
            while($record_chef=mysqli_fetch_array($recordchef)){
              $id=$record_chef['id'];
          ...
          print_r( '<div class="col-lg-4 col-md-6">
            <div class="member" data-aos="zoom-in" data-aos-delay="100">
              <img style="width:450px; height:300px" src="forms/upload/'.$img.'" class="img-fluid" alt="">
